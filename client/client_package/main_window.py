...
from client_package.add_contact import AddContactDialog
...
class ClientMainWindow(QMainWindow):
    ...
    def set_active_user(self):
        ...
        try:
            self.current_chat_key = self.transport.key_request(
                self.current_chat)
            logger_client.debug(f'Загружен открытый ключ для '
                                f'{self.current_chat}')
            ...
            self.current_chat_key = None
            self.encryptor = None
            logger_client.debug(f'Не удалось получить ключ для '
                                f'{self.current_chat}')
    ...
    def add_contact(self, new_contact):
        ...
        try:
            ...
            logger_client.info(f'Успешно добавлен контакт {new_contact}')
    ...
    def delete_contact(self, item):
        ...
        try:
            ...
            self.clients_list_update()
            logger_client.info(f'Успешно удалён контакт {selected}')
