...
def get_data():
    title = ['Изготовитель системы', 'Название ОС', 'Код продукта', 'Тип системы']
    os_prod_list = []
    os_name_list = []
    os_code_list = []
    os_type_list = []
...
def write_to_csv(filename):
    ...
    with open(filename, 'w', encoding='utf-8') as f:
        write_f_content = csv.writer(f, quoting=csv.QUOTE_NONNUMERIC)
        write_f_content.writerows(main_data)
